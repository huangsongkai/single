			...
			<form class="layui-form" action="?ac=post" method="post">
				...
				<div class="layui-form-item inline" style="width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text" name="bankName" lay-verify="required" autocomplete="off" class="layui-input"  value="<%=banks.getString("bankName") %>">
					</div>
				</div>
				<div class="layui-form-item inline" style=" width: 40%">
					<label class="layui-form-label" style=" width: 30%">银行利率(a)</label>
					<div class="layui-input-inline">
						<input type="text" name="bankrate" lay-verify="required|number" autocomplete="off" class="layui-input" value="<%=banks.getString("bankrate") %>" placeholder="单位为厘">
					</div>
				</div>
					...
					<div class="layui-input-inline">
			      	<input type="text" name="rate" id="rate"  lay-verify="required|number" value="<%=banks.getString("rate") %>" class="layui-input"  placeholder="单位为厘">
			      </div>
				</div>
				<div class="layui-form-item inline" style=" width: 40%">
					<label class="layui-form-label" style=" width: 30%">区域</label>
					<div class="layui-input-inline">
						<input type="text"  id="citySel"  lay-verify="required" autocomplete="off" class="layui-input" value="<%=banks.getString("regionalname")%>"  onclick="showMenu(); return false;" readonly="readonly">
						<input type="hidden"  id="regionalcode" name="regionalcode"  value="<%=banks.getString("regioncode") %>">
					</div>
