...
<!--				<input type="hidden" name="usernameid" lay-verify="nickname" autocomplete="off" class="layui-input" value="">-->
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text" name="legalperson" lay-verify="required" autocomplete="off" class="layui-input" value="">
					</div>
				</div>
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
			      	<input type="text" name="implementdate" id="implementdate"  lay-verify="required|date" placeholder="2000-01-01" autocomplete="off" class="layui-input" onclick="layui.laydate({elem: this})">
			      </div>
				</div>
				<div class="layui-form-item inline" style=" width: 40%">
					<label class="layui-form-label" style=" width: 30%"s>备注</label>
					<div class="layui-input-inline">
						<input type="text" name="common" lay-verify="" autocomplete="off" class="layui-input" value="">
					</div>
				</div>
	...
	if(ac.equals("post")){
		...
		String sql = "INSERT INTO g_distributor (name, legalperson,implementdate,regioncode,common,createid,createtime) VALUES ('"+name+"','"+legalperson+"','"+implementdate+"','"+regionalcode+"','"+common+"','"+Suid+"',now()"+")";
