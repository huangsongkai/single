        	...
        	<%
				...
				//查询的字段局部语句
		 		...
		 		if(search_val.length()>1){
		 			search="where typegroupname like '%"+search_val+"%'";
		 		}
		 		//计算出总页数
				String zpag_sql="select count(1) as row from typegroup "+search+";";
    ...
    <table class="cuoz" id="table" data-toggle="table" data-show-toggle="true" data-show-columns="true" data-show-export="true" >
        <thead>
          ...
          <%
		        ...
		        String typegroup_sql= "select * from typegroup "+search+" limit  "+(pages-1)*10+",10;";
          ...
          <tr>
	        ...
	        <td class="" ><%=i %></td>
			<td class=""><%=groups.getString("typegroupname") %></td>
			<td class=""><%=groups.getString("typegroupcode") %></td>
