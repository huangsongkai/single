...
<div class="layui-collapse" lay-accordion>
	...
	<form class="layui-form" action="?ac=post&nodeid=<%=nodeid %>&process=<%=process %>&orderid=<%=orderid %>" method="post">
		...
		<div class="layui-form-item mar_20 ab" style="text-align:center;">
			...
			<button class="layui-btn layui-btn-danger" onclick="asd()">拒单</button>
	...
	<script>
		...
		layui.use(['element','form','layer'], function(){
			...
			if("post".equals(ac)){
				...
				//拼凑sql字符串
				String isnert_sql = "INSERT INTO dev_hcbjinrong.f_bank_industry "+
									"		(									 "+
									"		orderid,                             "+
									"		remarks,                             "+
									"		createid,                            "+
				...
				if(state){
					out.println("agree('"+orderid+"','"+nodeid1+"','"+process1+"','"+common+"')");
				}else{
