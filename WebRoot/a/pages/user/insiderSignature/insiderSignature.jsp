...
<%
		...
		String zpag_sql="SELECT COUNT(1) as row "+
						"FROM (SELECT  orderid ,MAX(STATUS) STATUS,processid,nodeid  FROM process_log WHERE  rolecode='industrysign' AND process_log.regionalcode LIKE '1000:1%'   GROUP BY orderid)process_log "+
