...
<%
		...
		//计算出总页数	 
		int zpag= db.Row("SELECT COUNT(1) as row FROM process_log LEFT JOIN order_sheet ON process_log.orderid=order_sheet.id LEFT JOIN order_customerfile ON order_customerfile.id= order_sheet.customeruid  WHERE process_log.rolecode='industrysign' "+search+";");
		zpag=(zpag+10-1)/10;
