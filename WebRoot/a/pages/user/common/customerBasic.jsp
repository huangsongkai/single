...
//订单id，
	...
	String sql = "SELECT "+  
					  ...
					  "contactaddress,                      "+  /*客户地址，*/
					  "ifnull(industrycategory,'自由职业')as industrycategory,		"+  /*客户行业，*/
					  ...
					  "type.typename as maritalStatus,      "+  /*婚姻状况，*/
					  "spousename,                          "+  /*配偶姓名*/
					  "spouseidnum,                         "+  /*配偶身份证号*/
					  "spousephone,                         "+  /*配偶联系电话*/
				 ...
				 "FROM order_sheet  "+  
					 ...
					 " LEFT JOIN TYPE ON type.typecode = order_customerfile.maritalstatus AND type.typegroupid=2 "+  
	    ...
	    <div class="layui-form-item">
		  ...
		  <div class="layui-form-item">
			    ...
			    <div class="layui-inline">
			      ...
			      <div class="layui-input-inline">
			        <input type="text"  readonly="readonly" class="layui-input" value="<%=report_info_rs.getString("creditrating") %>">
			      </div>
			    </div>
			    <div class="layui-inline">
