		        ...
		        <%
		        	...
		        	if("".equals(ac)){//默认首页  （倒序）
						customer_sql = "SELECT *															  "
										...
										+"  	order_sheet,                                                  "
										+"  	order_customerfile                                            "
										+"	WHERE  temp1.status = '1'         AND nodeid=12                                 "
							...
							customer_sql = "SELECT *															  "
										...
										+"    AND temp1.status = '1'          AND nodeid=12                                "
										+"    AND order_sheet.customeruid = order_customerfile.id             "
										+"    AND temp1.orderid = order_sheet.id                              "
										+" 	  AND operatorid = "+Suid+"              "
										+"    AND temp1.regionalcode LIKE '"+user.getRegionalcode()+"%'                           "
	    ...
	    <script type="text/javascript">   
	    	function bianji(orderid,nodeid,process){
	    		layer.open({
				  ...
				  shade: 0.5,
				  area: ['980px', '500px'],
				  content: '../visitingSupervisor/visitier_ti.jsp?orderid='+orderid+'&nodeid='+nodeid+'&process='+process 
