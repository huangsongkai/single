...
<html>
	...
	<body>
		          ...
		          <tr>
					...
					<input type="hidden" value="<%=customerPrs.getString("orderid") %>" name="orderid" id="orderid" />
					 <div class="layui-btn-group">
					    <button class="layui-btn" onclick="buttonin('<%=customerPrs.getString("orderid") %>','<%=customerPrs.getString("nodeid") %>','<%=customerPrs.getString("processid") %>')">接单</button>
					  </div>
					</td>
			      </tr>
			    <%i++;}%>
	    ...
	    <script type="text/javascript">   
	    	...
	    	//接单事件
	    	function buttonin(orderid,nodeid,process){
	    		//json对象 拼凑参数
