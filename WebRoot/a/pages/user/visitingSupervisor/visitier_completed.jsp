		          ...
		          <tr>
					...
					<input type="hidden" value="<%=customerPrs.getString("orderid") %>" name="orderid" id="orderid" />
					 <div class="layui-btn-group">
					    ...
					    <button class="layui-btn" onclick="check('<%=customerPrs.getString("orderid") %>')" >查看</button>
					  </div>
					</td>
			      </tr>
			    <%i++;}%>
	    ...
	    <script type="text/javascript">   
	    	function check(orderid){
	    		layer.open({
				  ...
				  shade: 0.5,
				  area: ['980px', '500px'],
				  content: 'visitier_check.jsp?orderid='+orderid 
