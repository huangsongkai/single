	    ...
	    <form class="layui-form" action="">
	    	<div class="layui-form-item">
			    ...
			    <div class="layui-inline">
				    ...
				    <div class="layui-input-inline" style="width: 150px;">
				      	<select lay-verType="tips" lay-filter="jiaoyanshi" id="jiaoyanshi" name="jiaoyanshi">
				          <option value="0">全部</option>
				        </select>
				    </div>
			    </div>
...
layui.use(['form','layer','jquery'], function(){
	...
	function find(){
		...
		var obj_str1 = {"xueqi":xueqi,"jiaoyanshi":jiaoyanshi,"department":department};
		var obj1 = JSON.stringify(obj_str1)
		var ret_str1=PostAjx('../../../../Api/v1/?p=web/kebiao/getAllSchoolTeacher',obj1,'<%=Suid%>','<%=Spc_token%>');
		obj1 = JSON.parse(ret_str1);
		console.log(obj1);		
		if(obj1.success){
			var data = obj1.data;
			...
			for(var i =0 ;i<data.length;i++){
				$("#class_grade_id").append("<td class='shan'>"+obj1.data[i].teacher_name+"</td>");
