	...
	<body>
		<div style="margin: 15px;">
			<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
				<legend>编辑学年学期</legend>
			</fieldset>
			<form class="layui-form" action="edit_academic_manage.jsp?ac=edit&id=<%=id%>" method="post" >
			<%
			String sqls="SELECT * FROM `academic_year` WHERE id='"+id+"';";
			...
			%>
                <div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text" id="academic_year" name="academic_year" class="layui-input" value="<%=Rs.getString("academic_year")%>" lay-verify="required" >
					</div>
				</div>	
				<div class="layui-form-item inline" style=" width: 40%">
					<label class="layui-form-label" style=" width: 30%">学年学期号简称</label>
					<div class="layui-input-inline">
						<input type="text" id="academic_yaer_as" name="academic_yaer_as" class="layui-input" value="<%=Rs.getString("academic_yaer_as")%>" >
					</div>
				</div>	
						<div class="layui-form-item inline" style=" width: 40%">
					<label class="layui-form-label" style=" width: 30%">学期周数</label>
					<div class="layui-input-inline">
						<input type="text" id="academic_weeks" name="academic_weeks" class="layui-input"   value="<%=Rs.getString("academic_weeks")%>" lay-verify="required">
					</div>
				</div>
				<div class="layui-form-item inline" style=" width: 40%">
					<label class="layui-form-label" style=" width: 30%">学期开始日期</label>
					<div class="layui-input-inline">
						<input type="text" id="start_date" name="start_date" class="layui-input"   value="<%=Rs.getString("start_date")%>" lay-verify="required">
					</div>
				</div>	
				<div class="layui-form-item inline" style=" width: 40%">
					<label class="layui-form-label" style=" width: 30%">起始周</label>
					<div class="layui-input-inline">
						<input type="text" id="start_week" name="start_week" class="layui-input" value="<%=Rs.getString("start_week")%>">
					</div>
				</div>
				<div class="layui-form-item inline" style=" width: 40%">
					<label class="layui-form-label" style=" width: 30%">截至周</label>
					<div class="layui-input-inline">
						<input type="text" id="end_week" name="end_week" class="layui-input" value="<%=Rs.getString("end_week")%>">
					</div>
				</div>	
				<div class="layui-form-item inline" style=" width: 40%">
					<label class="layui-form-label" style=" width: 30%">是否当前学期</label>
					<div class="layui-input-inline">
						<input type="checkbox" name="aa" value="1" class="layui-input" <% if("true".equals(Rs.getString("this_academic_tag"))){out.print("checked=\"checked\"");}%>>
					</div>
				</div>
...
<% if("edit".equals(ac)){ 
	...
	try{
	   String sql="UPDATE `academic_year` SET `academic_year`='"+academic_year+"',`academic_weeks`='"+academic_weeks+"',`start_date`='"+start_date+"',`academic_yaer_as`='"+academic_yaer_as+"',`start_week`='"+start_week+"',`end_week`='"+end_week+"',`this_academic_tag`='"+this_academic_tag+"' WHERE id='"+id+"';";
