...
<html>
	...
	<body  style='height:auto'>
		<div style="margin: 15px;">
			<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
				<legend>新建教师编制</legend>
			</fieldset>

			<form class="layui-form" action="?ac=post" method="post">

				<div class="layui-form-item inline">
					<label class="layui-form-label" >教师编制名称</label>
					<input type="hidden" name="id" value="">
					<div class="layui-input-inline">
						<input type="text" name="organizationname" lay-verify="required" autocomplete="off" class="layui-input"  value="">
					</div>
				</div>
				<div class="layui-form-item inline" >
					<label class="layui-form-label" >教师编制编码</label>
					<div class="layui-input-inline">
						<input type="text" name="organizationcode" lay-verify="required" autocomplete="off" class="layui-input" value=""  >
					</div>
				</div>
	...
	if(ac.equals("post")){
		...
		String checkSql ="select count(id) as row from teacher_organization t  where t.organizationcode='"+organizationcode+"'";
		int rows = db.Row(checkSql);
		if(rows>0){
			out.print("layer.msg('编码已存在,请勿重新添加')");
		}else{
		String sql = "INSERT INTO teacher_organization (organizationname,organizationcode) VALUES ('"+organizationname+"','"+organizationcode+"')";
