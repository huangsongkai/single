...
<html>
			...
			<form class="layui-form" action="?ac=post" method="post">
				<%
			        		String id = request.getParameter("id");
			          		String bank_sql = "select t.* from teacher_position t  where  t.id = "+id;
				...
				<div class="layui-form-item inline" >
					...
					<div class="layui-input-inline">
						<input type="text" name="positionname" lay-verify="required" autocomplete="off" class="layui-input"  value="<%=banks.getString("positionname") %>">
					</div>
				</div>
				<div class="layui-form-item inline">
					<label class="layui-form-label" >岗位编码</label>
					<div class="layui-input-inline">
						<input type="text" name="positioncode" lay-verify="required" autocomplete="off" class="layui-input" value="<%=banks.getString("positioncode") %>"  readonly >
					</div>
				</div>
	...
	if(ac.equals("post")){
		String positioncode = "";
		String positionname = "";
		positioncode = request.getParameter("positioncode");
		positionname = request.getParameter("positionname");
		int ids = Integer.parseInt(request.getParameter("id"));
		String sql = "update teacher_position t set positionname='"+positionname+ "',positionname='"+positionname+"'  where t.id = "+id;
