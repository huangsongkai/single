			...
			<form class="layui-form" action="?ac=add" method="post" >
                ...
                <div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text" id="teacher_number" name="teacher_number" class="layui-input"    lay-verify="required" >
					</div>
				</div>	
				<div class="layui-form-item inline" style=" width: 40%">
					<label class="layui-form-label" style=" width: 30%">教师姓名</label>
					<div class="layui-input-inline">
						<input type="text" id="teacher_name" name="teacher_name" class="layui-input"   lay-verify="required"  >
					</div>
				</div>
							<div class="layui-form-item inline" style=" width: 40%">
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text" id="new_name" name="new_name" class="layui-input"  lay-verify=""  >
					</div>
				</div>
				<div class="layui-form-item inline" style=" width: 40%">
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<select class="layui-input" lay-search name="teacher_class">
							<%
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text" id="birthday" name="birthday" class="layui-input time"  readonly  lay-verify=""  >
					</div>
				</div>	
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<select class="layui-input" name="director" lay-search  lay-verify="required" >
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
<%--						<input type="text" id="political_status" name="political_status" class="layui-input"   lay-verify="required" >--%>
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text" id="native_place" name="native_place" class="layui-input"   lay-verify=""  >
					</div>
				</div>
				<div class="layui-form-item inline" style=" width: 40%">
					<label class="layui-form-label" style=" width: 30%">行政级别</label>
					<div class="layui-input-inline">
<%--						<input type="text" id="administrative_level" name="administrative_level" class="layui-input"  value=""  lay-verify="required">--%>
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<select class="layui-input" name="teachering_office" lay-search id="teachering_office" >
							<option value="">无</option>
							<%
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<select class="layui-input" name="teaching_staff_office" lay-search id="teaching_staff_office"  >
							<option value="">无</option>
						</select>
					</div>
				</div>
...
<%--						<input type="text" id="degree" name="degree" class="layui-input" >--%>
					...
					<div class="layui-input-inline">
						<input type="text" id="graduate_shcool" name="graduate_shcool" class="layui-input"   lay-verify=""  >
					</div>
				</div>
...
<%
	...
	if("add".equals(ac)){
		...
		System.out.println("check "+checkSql );
		if(db.Row(checkSql)==0){
				...
				if(state){
				   out.println("<script>parent.layer.msg('添加教师信息 成功', {icon:1,time:1000,offset:'150px'},function(){parent.location.reload();}); </script>");
			   }else{
