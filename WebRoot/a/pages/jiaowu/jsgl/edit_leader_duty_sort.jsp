...
<html>
			...
			<form class="layui-form" action="?ac=post" method="post">
				<%
			        		String id = request.getParameter("id");
			          		String bank_sql = "select t.* from teacher_duties t  where  t.id = "+id;
				...
				<div class="layui-form-item inline" >
					...
					<div class="layui-input-inline">
						<input type="text" name="dutiesname" lay-verify="required" autocomplete="off" class="layui-input"  value="<%=banks.getString("dutiesname") %>">
					</div>
				</div>
				<div class="layui-form-item inline">
					<label class="layui-form-label" >职称编码</label>
					<div class="layui-input-inline">
						<input type="text" name="dutiescode" lay-verify="required" autocomplete="off" class="layui-input" value="<%=banks.getString("dutiescode") %>"  readonly >
					</div>
				</div>
	...
	if(ac.equals("post")){
		...
		String sql = "update teacher_duties t set dutiesname='"+dutiesname+ "',dutiescode='"+dutiescode+"'  where t.id = "+id;
