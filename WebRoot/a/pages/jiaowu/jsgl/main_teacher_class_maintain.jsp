	...
	<body  style='height:auto'>
		...
		<div style="margin: 15px;">
			...
			<form class="layui-form" action="?ac=post" method="post">
				...
				<div class="layui-form-item inline">
					<label class="layui-form-label">银行利率</label>
					<div class="layui-input-inline">
						<input type="text" readonly="readonly" name="bankrate" lay-verify="required" autocomplete="off" class="layui-input" value="<%=banks.getString("rate") %>">
					</div>
		...
		<script type="text/javascript" src="../../js/layui2/layui.js"></script>
		<script><!--
