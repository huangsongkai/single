...
<html>
			...
			<form class="layui-form" action="?ac=post" method="post">
				...
				<div class="layui-form-item inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="teacher_title_name" lay-verify="required" autocomplete="off" class="layui-input"  value="">
					</div>
				</div>
				<div class="layui-form-item inline">
					<label class="layui-form-label" >教师职称档次</label>
					<div class="layui-input-inline">
						<input type="text" name="teacher_title_grade" lay-verify="required" autocomplete="off" class="layui-input"  value="">
					</div>
				</div>
				<div class="layui-form-item inline" >
					<label class="layui-form-label" >教师职称编码</label>
					<div class="layui-input-inline">
						<input type="text" name="teacher_title_code" lay-verify="required" autocomplete="off" class="layui-input" value=""  >
					</div>
				</div>
	...
	if(ac.equals("post")){
		...
		String checkSql ="select count(id) as row from teacher_title t  where t.teacher_title_code='"+teacher_title_code+"'";
		int rows = db.Row(checkSql);
		if(rows>0){
			out.print("layer.msg('编码已存在,请勿重新添加')");
		}else{
		String sql = "INSERT INTO teacher_title (teacher_title_name,teacher_title_code,teacher_title_grade) VALUES ('"+teacher_title_name+"','"+teacher_title_code+"','"+teacher_title_grade+"')";
