...
<html>
			...
			<form class="layui-form" action="?ac=post" method="post">
				<%
			        		String id = request.getParameter("id");
			          		String bank_sql = "select t.* from teacher_organization t  where  t.id = "+id;
				...
				<div class="layui-form-item inline" >
					...
					<div class="layui-input-inline">
						<input type="text" name="organizationname" lay-verify="required" autocomplete="off" class="layui-input"  value="<%=banks.getString("organizationname") %>">
					</div>
				</div>
				<div class="layui-form-item inline">
					<label class="layui-form-label" >教师类别职称</label>
					<div class="layui-input-inline">
						<input type="text" name="organizationcode" lay-verify="required" autocomplete="off" class="layui-input" value="<%=banks.getString("organizationcode") %>" readonly >
					</div>
				</div>
	...
	if(ac.equals("post")){
		...
		String sql = "update teacher_organization t set organizationname='"+organizationname+ "',organizationcode='"+organizationcode+"'"+" where t.id = "+id;
