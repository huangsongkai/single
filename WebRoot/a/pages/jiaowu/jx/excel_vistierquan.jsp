...
<%
    ...
    String filename = new String(("全院课时导出").getBytes("GBK"),"ISO-8859-1"); 
		...
		<table id="table" style="width:160%;table-layout: fixed;" >
		   ...
		   <tbody>
		   		...
		   		String sql ="	select t.teaching_task_id,	ifnull(t3.people_number_nan,0) people_number_nan,                                                       "+
								...
								"	LEFT JOIN dict_courses t4 ON t1.course_id = t4.id where t.state=3 and t5.teachering_office in ( select id from teaching_research where departments_id="+departments_id+")  GROUP BY t.teaching_task_id ";		   		
