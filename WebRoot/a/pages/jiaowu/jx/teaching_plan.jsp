...
<%
		...
		common common=new common();
 		String search="where t.semester='"+semester+"' and t.add_user= "+Suid;
			...
			"<td >"+Rs.getString("class_begins_weeks")+"</td>\r\n"+
				"<td >"+
				    "<div class=\"layui-btn-group\">"+
			             ...
			             "<button class=\"layui-btn\" onclick=\"del('"+Rs.getString("task_id")+"')\">删除</button>"+
			 	"</div>"+
				"</td>\r\n"+
		      "</tr>\r\n\r\n";
		   list.add(html_str);
					 	...
					 	form.on('select(semester)', function(data){
						    ...
						    if(semesterval=='0'){
								return false;
								    ...
								    window.location.href="teaching_plan.jsp?ac=&semester="+semesterval
									return true;
								    }
						});
				});
...
<%
		if("delete".equals(ac)){
			...
			if(upstate){
				   out.println("<script>parent.layer.msg('删除教师授课计划成功', {icon:1,time:1000,offset:'150px'},window.location.replace('./teaching_plan.jsp');)</script>");
