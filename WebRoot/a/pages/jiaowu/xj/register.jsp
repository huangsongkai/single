...
<!--        <button class="layui-btn " >删除</button>-->
        <button class="layui-btn "  onclick="newDistrbutor()" >新建</button>
        	<%
		       	//获取文件后面的对象 数据
    ...
    <table class="cuoz" id="table" data-toggle="table" data-show-toggle="true" data-show-columns="true" data-show-export="true" >
        <thead>
            <tr>
              ...
              <th data-field="注册状态"     data-sortable="true" data-filter-control="select" data-visible="true" >注册状态</th>
              <th data-field="欠费"     data-sortable="true" data-filter-control="select" data-visible="true" >欠费</th>
              <th data-field="退费标记"     data-sortable="true" data-filter-control="select" data-visible="true" >退费标记</th>
              <th data-field="缓交标记"     data-sortable="true" data-filter-control="select" data-visible="true" >缓交标记</th>
              <th data-field="票务号"     data-sortable="true" data-filter-control="select" data-visible="true" >票务号</th>
              <th data-field="交费次数"     data-sortable="true" data-filter-control="select" data-visible="true" >交费次数</th>
              <th data-field="收费标准"     data-sortable="true" data-filter-control="select" data-visible="true" >收费标准</th>
              <th data-field="收费日期"     data-sortable="true" data-filter-control="select" data-visible="true" >收费日期</th>
