    ...
    <table class="cuoz" id="table" data-toggle="table" data-show-toggle="true" data-show-columns="true" data-show-export="true" >
        <thead>
            <tr>
              ...
              <th data-field="教务系统班号"     data-sortable="true" data-filter-control="select" data-visible="true" >教务系统班号</th>
              <th data-field="准考证号"     data-sortable="true" data-filter-control="select" data-visible="true" >准考证号</th>
              <th data-field="姓名"     data-sortable="true" data-filter-control="select" data-visible="true" >姓名</th>
              <th data-field="曾用名"     data-sortable="true" data-filter-control="select" data-visible="true" >曾用名</th>
              <th data-field="性别"     data-sortable="true" data-filter-control="select" data-visible="true" >性别</th>
              <th data-field="出生日期"     data-sortable="true" data-filter-control="select" data-visible="true" >出生日期</th>
              <th data-field="民族"     data-sortable="true" data-filter-control="select" data-visible="true" >民族</th>
              <th data-field="分院"     data-sortable="true" data-filter-control="select" data-visible="true" >分院</th>
              <th data-field="系院"     data-sortable="true" data-filter-control="select" data-visible="true" >系院</th>
              <th data-field="专业"     data-sortable="true" data-filter-control="select" data-visible="true" >专业</th>
              <th data-field="学制"     data-sortable="true" data-filter-control="select" data-visible="true" >分院</th>
