        ...
        <button class="layui-btn " onclick="location.reload()" > 刷新</button>
        	<%
				...
				//查询的字段局部语句
		 		...
		 		//计算出总页数
				String zpag_sql="select count(t.id)  row from staff_level t   "+search;
		        ...
		        String bank_sql= "select t.*  from staff_level  t  "+search+"  limit "+(pages-1)*limits+","+limits+";";
		        String html_str = "";
				StringBuffer sb = new StringBuffer();
            		...
            		while(groups.next()){
            			...
            			String level = groups.getString("level");
                     	if(StringUtils.isBlank(level)){level="";}
            			String level_date = groups.getString("level_date");
                     	if(StringUtils.isBlank(level_date)){level_date="";}
            			String level_num = groups.getString("level_num");
                     	if(StringUtils.isBlank(level_num)){level_num="";}
            			...
            			html_str = "<tr>"
   							...
   							+"<td class=\"\">"+level+"</td>          "
   							+"<td class=\"\">"+level_date +"</td>          "
   							+"<td class=\"\">"+level_num +"</td>          "
	          ...
	          <div id="field">
	           ...
	           <div>
							...
							<input type="text" class="layui-btn" value="" id='wenjianname' readonly placeholder="请上传Excel" style="background: rgb(227, 227, 227); color:black;">
		       				  <a href ="./xingzheng.xls" target="_blank" style="font-size:16px;margin-left:15px;">模板下载</a>   
		        </div>
	    </form>   
	    </div>
    <table class="cuoz" id="table" data-toggle="table" data-show-toggle="true" data-show-columns="true" data-show-export="true"  >
        <thead>
            <tr>
              ...
              <th data-field="任职文号"     data-sortable="true" data-filter-control="select" data-visible="true" >任职文号</th>
			...
			$(function() {
		        $("#file_form").submit(
		                function() {
		                    ...
		                    var updaetFiled = '';
		                    var other = "";
		                   	var updaetFiled = 'name,id_number,level,level_date,level_num';
