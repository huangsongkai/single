	          ...
	          <div id="field">
	           ...
	           <div>
							...
							<input type="text" class="layui-btn" value="" id='wenjianname' readonly placeholder="请上传Excel" style="background: rgb(227, 227, 227); color:black;">
		       				  <a href ="./fafang.xls" target="_blank" style="font-size:16px;margin-left:15px;">模板下载</a>   
		        </div>
...
if("deletet".equals(ac)){ 
	...
	try{
	   ...
	   if(db.executeUpdate(dsql)==true){
		   out.println("<script>parent.layer.msg('删除成功');window.location.replace('./grant_search.jsp');</script>");
	   }
	   else{
