		...
		<div style="margin: 15px;">
			...
			<form class="layui-form" action="?ac=update" method="post"  >
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text"  lay-verify="required"  id="teacher_name" name="teacher_name" value="<%=base_teacher_name %>" class="layui-input"  >
					</div>
				</div>
						<div class="layui-form-item inline" style=" width: 40%">
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text" lay-verify="" id="new_name" name="new_name" class="layui-input"  value="<%=new_name%>" >
					</div>
				</div>
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text" id="id_number" name="id_number" value="<%=base_id_number %>" class="layui-input"  lay-filter="required">
					</div>
				</div>
					<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text" id="nation" name="nation" value="<%=nation %>" class="layui-input"  lay-verify="" >
					</div>
				</div>
				<div class="layui-form-item inline" style=" width: 40%">
					<label class="layui-form-label" style=" width: 30%">教职工标识</label>
					<div class="layui-input-inline" >
						<select name="teacher_mark" class="layui-input"  lay-verify="">
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<select class="layui-input" name="teacher_class" lay-verify="">
							<option value="">无</option>
							<%
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text" id="birthday" name="birthday" value="<%=base_birthday %>" class="layui-input time"   lay-verify="" >
					</div>
				</div>	
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<select class="layui-input" name="director" lay-verify="">
							<option value="">无</option>
...
<%--						<input type="text" id="administrative_level" name="administrative_level" class="layui-input"  value="<%=administrative_level%> "  lay-verify="required">--%>
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<select class="layui-input" name="faculty"  lay-filter="department" id="faculty" lay-search >
							<option value="">无</option>
							<%
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<select class="layui-input" name="technical_title" > 
							<option value="">无</option>
							<%
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
<%--						<input type="text" id="education" name="education" value="<%=base_education %>" class="layui-input" >--%>
...
<%
	...
	if("update".equals(ac)){
		...
		if(!StringUtils.isBlank(teacher_name)){
		 ...
		 teacher_mark = request.getParameter("teacher_mark");
		 if(!StringUtils.isBlank(teacher_mark)){
				values = values +",teacher_mark='"+teacher_mark+"'";
			}
		 state = request.getParameter("state");
		 if(!StringUtils.isBlank(state)){
				values = values +",state='"+state+"'";
			}
		 teaching_staff_office = request.getParameter("teaching_staff_office");
		...
		if(upstate){
		   out.println("<script>parent.layer.msg('修改教职工信息 成功', {icon:1,time:1000,offset:'150px'},function(){parent.location.reload();}); </script>");
	   }else{
		   out.println("<script>parent.layer.msg('修改教职工信息 失败');</script>");
	   }
	}
%>
<%
