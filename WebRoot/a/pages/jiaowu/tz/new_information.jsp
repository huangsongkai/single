		...
		<div style="margin: 15px;">
			...
			<form  action="?ac=editdata" method="post">
				...
				<div class="layui-form-item inline" style=" width: 40%">
					...
					<div class="layui-input-inline">
						<input type="text" id="author" readonly="readonly" value="<%=Susername%>" name="author" lay-verify="required" autocomplete="off" class="layui-input" >
					</div>
				</div>
					...
					<label class="layui-form-label" style=" width: 30%">可见范围</label>
					 <div margin-left="100px">
					     <div class="layui-input-block">
                              <div>  <input type="checkbox" name="like" value="1" >外网可见</div>
                               <div> <input type="checkbox" name="like" value="2" checked>内网可见</div>
                              <div>  <input type="checkbox" name="like" value="3">内网登录可见</div>
                         </div>	 
                     </div>
				</div>
				<div class="layui-form-item inline" style="width: 40%">
					...
					<input type="hidden" name="id" value="">
						<select id="range" name="range" class="layui-input" style="width: 190px"> 
                            <option  value="2">校内公开</option> 
                            <option  value="1">社会公开</option>
                        </select> 
			    </div>
	  ...
	  <script>      
	    ...
	    var basePath=localhostPath+projectName+"/";
			...
			layui.use(['form', 'layedit', 'laydate'], function() {
			  ...
			  var Suid=$("#Suid").val();
			  var uuid=$("#uuid").val();
			  var Purl=basePath+"/Api/v1/?p=web/cms/articles/addArticles";
		    ...
		    %>
			   ...
			   var title="<%=title%>";	
			     ...
			     if(title==""){
			    	 parent.layer.msg('请填标题');
			    
				     }else if(classna==""){
				        parent.layer.msg('请填栏目');
				    	  
					    }else if(text==""){
					        parent.layer.msg('请填文章内容信息');
					    	   
						    }else if(num==""){
						        parent.layer.msg('请填公开序号');
						    	  
							    }else if(isNaN(num)){
							        parent.layer.msg('公开序号填写数字!!!');
							    	  
							        }else if(author==""){
							        parent.layer.msg('请将发布人信息');
