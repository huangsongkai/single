...
<!--        <button class="layui-btn " >删除</button>-->
        <button class="layui-btn "  onclick="newDistrbutor()" >新建成绩项目</button>
        	<%
		       	//获取文件后面的对象 数据
				...
				//查询的字段局部语句
		 		...
		 		//计算出总页数
				String zpag_sql="select count(t.id)  row from jz_achievement_project t   "+search;
		        ...
		        String bank_sql= "select t.*  from jz_achievement_project  t "+search+"  limit "+(pages-1)*limits+","+limits+";";
		        ...
		        ArrayList<String> list  = new ArrayList<String>();
            		...
            		while(groups.next()){
            			String status ="";
            			if(groups.getString("status").equals("2")){
            				status ="否";
            			}else if(groups.getString("status").equals("1")){
            				status ="是";
            			}else{
            				status ="无";
            			}
            			html_str = "<tr>"
   							...
   							+"<td class=\"\">"+groups.getString("mixpercent")+"</td>         "
   							+"<td class=\"\">"+groups.getString("maxpercent")+"</td>         "
   							+"<td class=\"\">"+status+"</td>         "
    ...
    <table class="cuoz" id="table" data-toggle="table" data-show-toggle="true" data-show-columns="true" data-show-export="true" >
        <thead>
            <tr>
              ...
              <th data-field="最小百分比"     data-sortable="true" data-filter-control="select" data-visible="true" >最小百分比%</th>
              <th data-field="最大百分比"     data-sortable="true" data-filter-control="select" data-visible="true" >最大百分比%</th>
