...
<html>
	...
	<body  style='height:auto'>
		<div style="margin: 15px;">
			...
			<form class="layui-form" action="?ac=post" method="post">
				...
				<div class="layui-form-item inline" >
					<label class="layui-form-label" >辅助教具编码</label>
					<div class="layui-input-inline">
	...
	if(ac.equals("post")){
		...
		String checkSql ="select count(id) as row from jz_teaching_aids t  where t.code='"+code+"'";
		int rows = db.Row(checkSql);
		if(rows>0){
			out.print("layer.msg('编码已存在,请勿重新添加')");
		}else{
		String sql = "INSERT INTO jz_teaching_aids (name,code) VALUES ('"+name+"','"+code+"')";
