...
<html>
	...
	if(ac.equals("post")){
		...
		String checkSql ="select count(id) as row from dict_process_symbol t  where t.process_symbol='"+code+"'";
		int rows = db.Row(checkSql);
		if(rows>0){
			out.print("layer.msg('编码已存在,请勿重新添加')");
		}else{
		String sql = "INSERT INTO dict_process_symbol (process_symbol_name,process_symbol,publicstate) VALUES ('"+name+"','"+code+"','"+publicstate+"')";
