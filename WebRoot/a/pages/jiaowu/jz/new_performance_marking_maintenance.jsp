...
<html>
	...
	if(ac.equals("post")){
		...
		String checkSql ="select count(id) as row from teacher_title t  where t.jz_achievement_mark='"+code+"'";
		int rows = db.Row(checkSql);
		if(rows>0){
			out.print("layer.msg('编码已存在,请勿重新添加')");
		}else{
		String sql = "INSERT INTO jz_achievement_mark (name,code,fraction,status) VALUES ('"+name+"','"+code+"','"+fraction+"','"+status+"')";
