...
<html>
	...
	<body  style='height:auto'>
		<div style="margin: 15px;">
			...
			<form class="layui-form" action="?ac=post" method="post">
				...
				<div class="layui-form-item inline" >
					<label class="layui-form-label" >分数等级</label>
					<div class="layui-input-inline">
						<input type="text" name="fraction" lay-verify="required" autocomplete="off" class="layui-input" value=""  >
					</div>
				</div>
				<div class="layui-form-item inline" >
					<label class="layui-form-label" >开始分数</label>
					<div class="layui-input-inline">
						<input type="text" name="start_fraction" lay-verify="required" autocomplete="off" class="layui-input" value=""  >
					</div>
				</div>
				<div class="layui-form-item inline" >
					<label class="layui-form-label" >结束分数</label>
					<div class="layui-input-inline">
						<input type="text" name="end_fraction" lay-verify="required" autocomplete="off" class="layui-input" value=""  >
					</div>
				</div>
				<div class="layui-form-item inline" >
	...
	if(ac.equals("post")){
		...
		String checkSql ="select count(id) as row from jz_achievement_leve t  where t.code='"+code+"'";
		int rows = db.Row(checkSql);
		if(rows>0){
			out.print("layer.msg('编码已存在,请勿重新添加')");
		}else{
		String sql = "INSERT INTO jz_achievement_leve (name,code,fraction,start_fraction,end_fraction,style_fraction) VALUES ('"+name+"','"+code+"','"+fraction+"','"+start_fraction+"','"+end_fraction+"','"+style_fraction+"')";
