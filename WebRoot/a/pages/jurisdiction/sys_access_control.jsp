...
<body>
    <div class="container">
       <table id="dg" style="width:100%;height:554px" title="<%=Mokuai%>"  data-options="
            ...
            <thead> 
                <tr>
                    <th field="id" width="120">权限编号</th>
                    <th field="user_group_name" width="200">角色名</th>
                    <th field="rolecode" width="200">角色标识</th>
                     <th field="user_group_txt" width="500">角色说明</th>
                     <th field="powerarrnum" width="80">权限数</th>
           ...
           if(parseInt(obj.resultCode)!=1000)
            ...
            for(var i=0; i<obj.threads.length; i++){
               ...
               //ExeTime: JSON.stringify(obj.threads[i].ExeTime),
                    id: obj.threads[i].id,
                    user_group_name: obj.threads[i].user_group_name,
                    user_group_txt: obj.threads[i].user_group_txt,
                    rolecode:obj.threads[i].rolecode,
                    company_address: obj.threads[i].company_address,
                    powerarrnum: obj.threads[i].powerarrnum+''+'个',
