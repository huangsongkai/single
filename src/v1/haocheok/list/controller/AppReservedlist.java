...
import v1.haocheok.list.service.impl.NotResrvedListServiceImpl;
import v1.haocheok.list.service.impl.WaitingServiceImpl;

public class AppReservedlist {

	public void getReservedlist(HttpServletRequest request, HttpServletResponse response,String RequestJson,InfoEntity info) throws ServletException, IOException {
    	...
    	PrintWriter out = response.getWriter();
		   ...
		   try { // 解析开始
			   ...
			   System.out.println("已预约列表模块接收数据："+RequestJson);
			...
			//调用应用层实现类接口
			NotResrvedListServiceImpl notResrvedListServiceImpl = new NotResrvedListServiceImpl();
			String outputString = notResrvedListServiceImpl.getNotResrvedList(rolecode, info);
