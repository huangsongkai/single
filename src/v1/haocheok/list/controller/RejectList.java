...
import v1.haocheok.list.service.impl.RejectListServiceImpl;
import v1.haocheok.list.service.impl.WaitingServiceImpl;

public class RejectList {

	public void getRejectList(HttpServletRequest request, HttpServletResponse response,String RequestJson,InfoEntity info) throws ServletException, IOException {
    	...
    	PrintWriter out = response.getWriter();
		   ...
		   try { // 解析开始
			...
			//调用应用层实现类接口
			RejectListServiceImpl rejectListServiceImpl = new RejectListServiceImpl();
			String outputString = rejectListServiceImpl.getRejectList(rolecode, info);
