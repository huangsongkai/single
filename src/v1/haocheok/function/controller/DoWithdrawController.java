 ...
 * @date:2017-10-18 下午04:03:24
 */
public class DoWithdrawController {
	
	
	public void DoWithdraw(HttpServletRequest request,
		...
		try { // 解析开始
			...
			System.out.println("app撤回模块接收数据：" + RequestJson);
...
System.out.println("status_form"+status_form);
...
//			String basesql = "SELECT * FROM t_yewudian , t_yewuxian WHERE t_yewuxian.nodeid_form = '"+nodeid+"' and t_yewuxian.status_form = '"+status_form+"' and t_yewudian.nodeid = t_yewuxian.nodeid_form AND t_yewudian.t_yewumian_id = '"+processid+"' AND rolecode = '"+rolecode+"';";
	...
	/*public HashMap<String, Object> getRoleinfo( String nodeid){
		...
		String sql = "SELECT zk_role.rolecode as rolecode,name FROM zk_role,t_yewudian WHERE nodeid = '"+nodeid+"' AND zk_role.id = t_yewudian.roleid ";
