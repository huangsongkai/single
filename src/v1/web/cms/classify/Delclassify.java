 ...
 * @version 自动创建时间：2017-11-16 15:49:38
 * 类说明 CMS分类接口-删除分类
 */
...
public class Delclassify {
	...
	public Delclassify (HttpServletRequest request, HttpServletResponse response) {
	...
	public void Transmit(String Token,String UUID,String USERID,String DID,String Mdels,String NetMode,String ChannelId,String RequestJson,String ip,String GPS,String GPSLocal,String AppKeyType,long TimeStart) throws ServletException, IOException {
	  ...
	  try {   
	            ...
	            // 删除部分
	              String UPSQL="DELETE from cms_class where id ="+id;
			        if(db.executeUpdate(UPSQL)==true){
			          responsejson = "{\"success\":\"true\",\"resultCode\":\"1000\",\"msg\":\""+classname+"删除栏目成功\"}";
			        }else{
			    	 responsejson = "{\"success\":\"true\",\"resultCode\":\"404\",\"msg\":\""+classname+"删除栏目失败\"}";
			       }
