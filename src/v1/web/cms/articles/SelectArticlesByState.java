...
public class SelectArticlesByState {

	private HttpServletRequest request;
	private HttpServletResponse response;

	public SelectArticlesByState (HttpServletRequest request, HttpServletResponse response) {
	...
	public void Transmit(String Token,String UUID,String USERID,String DID,String Mdels,String NetMode,String ChannelId,String RequestJson,String ip,String GPS,String GPSLocal,String AppKeyType,long TimeStart) throws ServletException, IOException {
	  ...
	  try {   
          ...
          //分页 search
			 ...
			 int   Asum2=db.Row(" SELECT COUNT(*) as row FROM `cms_articles`  WHERE state='"+state+"' AND one_class_id in ("+fidss+")");
			 int Zongshu=Asum2;
          ...
          //通过二级栏目名查找文章          
          String SQL=" SELECT * FROM `cms_articles` WHERE state='"+state+"' AND one_class_id in ("+fidss+") ORDER BY id LIMIT "+DQcount2+", "+listnum2+" ";	  
