 ...
 * @version 自动创建时间：2017-11-15 17:04:27
 * 类说明 删除文章
 */
...
public class DelArticles {

	private HttpServletRequest request;
	private HttpServletResponse response;

	public DelArticles (HttpServletRequest request, HttpServletResponse response) {
	...
	public void Transmit(String Token,String UUID,String USERID,String DID,String Mdels,String NetMode,String ChannelId,String RequestJson,String ip,String GPS,String GPSLocal,String AppKeyType,long TimeStart) throws ServletException, IOException {
	  ...
	  try {   
	  	     ...
	  	     // 删除部分
              String UPSQL="DELETE from cms_articles where id ="+id;
		        if(db.executeUpdate(UPSQL)==true){
		          responsejson = "{\"success\":\"true\",\"resultCode\":\"1000\",\"msg\":\""+classname+"删除成功\"}";
		        }else{
		    	 responsejson = "{\"success\":\"true\",\"resultCode\":\"404\",\"msg\":\""+classname+"删除失败\"}";
		       }
