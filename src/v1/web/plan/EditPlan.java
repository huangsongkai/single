...
public class EditPlan {
	...
	public EditPlan (HttpServletRequest request, HttpServletResponse response) {
	...
	public void Transmit(String Token,String UUID,String USERID,String DID,String Mdels,String NetMode,String ChannelId,String RequestJson,String ip,String GPS,String GPSLocal,String AppKeyType,long TimeStart) throws ServletException, IOException {
	  ...
	  try {   
	  	     ...
	  	     //更新部分
              String UPSQL="UPDATE `teaching_plan` SET `"+field+"`='"+fieldValue+"' WHERE `course_id`="+majorId+" AND `school_year`="+schoolYear+" ";
		        if(db.executeUpdate(UPSQL)==true){
		          responsejson = "{\"success\":\"true\",\"resultCode\":\"1000\",\"msg\":\""+classname+"添加成功\"}";
		        }else{
		    	 responsejson = "{\"success\":\"true\",\"resultCode\":\"404\",\"msg\":\""+classname+"添加失败\"}";
		       }
